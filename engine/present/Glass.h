...
public:
    ...
    void capture();
    // Frosted panel at top-left-origin pixel coordinates.
    void panel(float x, float y, float w, float h, float radius);
...
private:
    ...
    int uRect_{-1}, uRadius_{-1}, uFbSize_{-1}, uPanelTex_{-1};
};
}
