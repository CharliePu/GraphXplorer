...
public:
    ...
    void clear();
    [[nodiscard]] gx::RenderProgress draw(const gx::FrameCommandBuffer &commands,
                                          const gx::UploadBudget &uploadBudget = gx::UploadBudget{});
    [[nodiscard]] gx::RenderProgress draw(std::span<const gx::DrawCommand> commands,
                                          const gx::UploadBudget &uploadBudget = gx::UploadBudget{});
